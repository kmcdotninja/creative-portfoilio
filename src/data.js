export const projects = [
  {
    name: 'Kutuby',
    description:
      'A learning app that turns Islamic studies for kids, age 4 to 10 into short, illustrated lessons that feel more like play than school.',
    ...
    team: [
      ...
      { name: 'Yaseer Ahmed', role: 'CEO & Product Lead' },
    ],
